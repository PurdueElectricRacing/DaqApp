...
class Ui_preferencesEditor(object):
    def setupUi(self, preferencesEditor):
        ...
        self.label_2 = QtWidgets.QLabel(preferencesEditor)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.busCombo = QtWidgets.QComboBox(preferencesEditor)
        self.busCombo.setObjectName("busCombo")
        self.horizontalLayout_3.addWidget(self.busCombo)
    ...
    def retranslateUi(self, preferencesEditor):
        ...
        self.label_2.setText(_translate("preferencesEditor", "Can Bus:"))
